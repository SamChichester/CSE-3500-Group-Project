...
class DynamicAStar: 
    ...
    def _update(self, s): 
        ...
        #We update the rhs based on the cost which is 1 and our current g value for this cell 
...
if __name__ == "__main__": 
    ...
    print("\nUpdating: changing cost at (2, 0) from 1 to 10 Total cost in this path: 14") 
    planner.update_grid((2, 0), 10) 
    print(planner.get_path()) 
 
    print("\nUpdating: changing cost at (0, 2) from 1 to 20 Total cost in this path: 15") 
    planner.update_grid((0, 2), 10) 
    print(planner.get_path()) 
